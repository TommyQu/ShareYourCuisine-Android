...
//        Select content images
    ...
    public void onValidationSucceeded() {
        ...
        recipe.setCreatedUserId(mAuth.getCurrentUser().getUid());
        recipe.setCreatedUserName(mAuth.getCurrentUser().getDisplayName());
        recipe.setCreatedUserAvatarUrl(mAuth.getCurrentUser().getPhotoUrl().toString());

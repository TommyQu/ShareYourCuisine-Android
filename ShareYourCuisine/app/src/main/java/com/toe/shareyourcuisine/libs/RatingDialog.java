package com.toe.shareyourcuisine.libs;
...
public class RatingDialog extends AppCompatDialog implements RatingBar.OnRatingBarChangeListener, View.OnClickListener {
    ...
    public interface RatingSubmitListener {
        void onRatingSubmit(float rating, boolean thresholdCleared);
    }
...
//            openForm();
    ...
    public void onRatingSubmit() {
        ...
        if (builder.ratingSubmitListener != null) {
            builder.ratingSubmitListener.onRatingSubmit(ratingBar.getRating(), thresholdPassed);
        }
...
//        showNever();
    ...
    public static class Builder {
        ...
        public Builder onRatingSubmit(RatingSubmitListener ratingSubmitListener) {
